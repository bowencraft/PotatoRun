...
if (player_amount > 0) {
	...
	draw_text_color(plr_axis_x1 - text_width/2 + plr_sprite_size + 4,plr_axis_y1 - plr_sprite_size /2 ,
...
if (player_amount > 1) {
	...
	draw_text_color(plr_axis_x2 - text_width/2 + plr_sprite_size + 4,plr_axis_y1 - plr_sprite_size /2 ,
...
if (player_amount > 2) {
	...
	draw_text_color(plr_axis_x1 - text_width/2 + plr_sprite_size + 4,plr_axis_y2 - plr_sprite_size /2 ,
...
if (player_amount > 3) {
	...
	"P3", c_white,c_white,c_white,c_white,1);
	draw_text_color(plr_axis_x2 - text_width/2 + plr_sprite_size + 4,plr_axis_y2 - plr_sprite_size /2 ,
